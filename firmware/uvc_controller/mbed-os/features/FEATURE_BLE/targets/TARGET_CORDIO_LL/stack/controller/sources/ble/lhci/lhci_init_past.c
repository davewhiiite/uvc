...
/*************************************************************************************************/
/*!
 *  \brief      Initialize LL HCI subsystem for PAST(Periodic advertising sync transfer) features.
 *
 *  This function initializes the LL HCI subsystem for PAST features commands.  It is
