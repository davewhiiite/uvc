...
#ifndef WSF_FCS_SIZE_OPTIMIZE
/*! \brief  Compile time flag for CRC code size optimization method. */
#define WSF_FCS_SIZE_OPTIMIZE FALSE
#endif
...
#if WSF_FCS_SIZE_OPTIMIZE == FALSE
 ...
 *  \param  pBuf     Byte to be added to CRC computation.
 *
 *  \return FCS value.
 */
/*************************************************************************************************/
