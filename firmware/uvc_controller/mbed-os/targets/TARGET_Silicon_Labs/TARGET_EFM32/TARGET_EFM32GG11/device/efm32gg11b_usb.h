...
typedef struct {
  ...
  __IOM uint32_t   DATTRIM1;           /**< Data TRIM 1 Values for USB DP and DM  */

  uint32_t         RESERVED1[1U];      /**< Reserved for future use **/
  __IOM uint32_t   LEMCTRL;            /**< USB LEM Control Register  */

  uint32_t         RESERVED2[227312U]; /**< Reserved for future use **/
  ...
  uint32_t         RESERVED6[185U];    /**< Reserved for future use **/
  ...
  uint32_t         RESERVED9[47U];     /**< Reserved registers */
  USB_HC_TypeDef   HC[14U];            /**< Host Channel Registers */

  uint32_t         RESERVED10[80U];    /**< Reserved for future use **/
  ...
  uint32_t         RESERVED13[50U];    /**< Reserved for future use **/
  ...
  uint32_t         RESERVED16[1U];     /**< Reserved registers */
  USB_DIEP_TypeDef DIEP[6U];           /**< Device IN Endpoint n Registers */

  uint32_t         RESERVED17[72U];    /**< Reserved for future use **/
  ...
  uint32_t         RESERVED20[2U];     /**< Reserved registers */
  USB_DOEP_TypeDef DOEP[6U];           /**< Device OUT Endpoint n Registers */

  uint32_t         RESERVED21[136U];   /**< Reserved for future use **/
  __IOM uint32_t   PCGCCTL;            /**< Power and Clock Gating Control Register  */

  uint32_t         RESERVED22[127U];   /**< Reserved registers */
  ...
  uint32_t         RESERVED34[512U];   /**< Reserved registers */
  __IOM uint32_t   FIFO12D[512U];      /**< Host Channel 12 FIFO  */

  uint32_t         RESERVED35[512U];   /**< Reserved registers */
  __IOM uint32_t   FIFO13D[512U];      /**< Host Channel 13 FIFO  */

  uint32_t         RESERVED36[17920U]; /**< Reserved registers */
...
/* Bit fields for USB DATTRIM1 */
#define _USB_DATTRIM1_RESETVALUE                   0x00000024UL                             /**< Default value for USB_DATTRIM1 */
#define _USB_DATTRIM1_MASK                         0x000FFFBFUL                             /**< Mask for USB_DATTRIM1 */
#define _USB_DATTRIM1_ROUT_SHIFT                   0                                        /**< Shift value for USB_ROUT */
#define _USB_DATTRIM1_ROUT_MASK                    0x3FUL                                   /**< Bit mask for USB_ROUT */
#define _USB_DATTRIM1_ROUT_DEFAULT                 0x00000024UL                             /**< Mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_ROUT_DEFAULT                  (_USB_DATTRIM1_ROUT_DEFAULT << 0)        /**< Shifted mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_ENDLYPULLUP                   (0x1UL << 7)                             /**< Enables Delay of Pull in TX Mode for Both FS and LS */
#define _USB_DATTRIM1_ENDLYPULLUP_SHIFT            7                                        /**< Shift value for USB_ENDLYPULLUP */
#define _USB_DATTRIM1_ENDLYPULLUP_MASK             0x80UL                                   /**< Bit mask for USB_ENDLYPULLUP */
#define _USB_DATTRIM1_ENDLYPULLUP_DEFAULT          0x00000000UL                             /**< Mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_ENDLYPULLUP_DEFAULT           (_USB_DATTRIM1_ENDLYPULLUP_DEFAULT << 7) /**< Shifted mode DEFAULT for USB_DATTRIM1 */
#define _USB_DATTRIM1_DLYPULLUPFS_SHIFT            8                                        /**< Shift value for USB_DLYPULLUPFS */
#define _USB_DATTRIM1_DLYPULLUPFS_MASK             0x300UL                                  /**< Bit mask for USB_DLYPULLUPFS */
#define _USB_DATTRIM1_DLYPULLUPFS_DEFAULT          0x00000000UL                             /**< Mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_DLYPULLUPFS_DEFAULT           (_USB_DATTRIM1_DLYPULLUPFS_DEFAULT << 8) /**< Shifted mode DEFAULT for USB_DATTRIM1 */
#define _USB_DATTRIM1_VCRSFS_SHIFT                 10                                       /**< Shift value for USB_VCRSFS */
#define _USB_DATTRIM1_VCRSFS_MASK                  0xC00UL                                  /**< Bit mask for USB_VCRSFS */
#define _USB_DATTRIM1_VCRSFS_DEFAULT               0x00000000UL                             /**< Mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_VCRSFS_DEFAULT                (_USB_DATTRIM1_VCRSFS_DEFAULT << 10)     /**< Shifted mode DEFAULT for USB_DATTRIM1 */
#define _USB_DATTRIM1_TFDMFS_SHIFT                 12                                       /**< Shift value for USB_TFDMFS */
#define _USB_DATTRIM1_TFDMFS_MASK                  0x3000UL                                 /**< Bit mask for USB_TFDMFS */
#define _USB_DATTRIM1_TFDMFS_DEFAULT               0x00000000UL                             /**< Mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_TFDMFS_DEFAULT                (_USB_DATTRIM1_TFDMFS_DEFAULT << 12)     /**< Shifted mode DEFAULT for USB_DATTRIM1 */
#define _USB_DATTRIM1_TRDMFS_SHIFT                 14                                       /**< Shift value for USB_TRDMFS */
#define _USB_DATTRIM1_TRDMFS_MASK                  0xC000UL                                 /**< Bit mask for USB_TRDMFS */
#define _USB_DATTRIM1_TRDMFS_DEFAULT               0x00000000UL                             /**< Mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_TRDMFS_DEFAULT                (_USB_DATTRIM1_TRDMFS_DEFAULT << 14)     /**< Shifted mode DEFAULT for USB_DATTRIM1 */
#define _USB_DATTRIM1_TFDPFS_SHIFT                 16                                       /**< Shift value for USB_TFDPFS */
#define _USB_DATTRIM1_TFDPFS_MASK                  0x30000UL                                /**< Bit mask for USB_TFDPFS */
#define _USB_DATTRIM1_TFDPFS_DEFAULT               0x00000000UL                             /**< Mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_TFDPFS_DEFAULT                (_USB_DATTRIM1_TFDPFS_DEFAULT << 16)     /**< Shifted mode DEFAULT for USB_DATTRIM1 */
#define _USB_DATTRIM1_TRDPFS_SHIFT                 18                                       /**< Shift value for USB_TRDPFS */
#define _USB_DATTRIM1_TRDPFS_MASK                  0xC0000UL                                /**< Bit mask for USB_TRDPFS */
#define _USB_DATTRIM1_TRDPFS_DEFAULT               0x00000000UL                             /**< Mode DEFAULT for USB_DATTRIM1 */
#define USB_DATTRIM1_TRDPFS_DEFAULT                (_USB_DATTRIM1_TRDPFS_DEFAULT << 18)     /**< Shifted mode DEFAULT for USB_DATTRIM1 */
...
#define USB_GOTGCTL_DBNCEFLTRBYPASS                (0x1UL << 15)                                /**< Debounce Filter Bypass */
...
#define _USB_DTHRCTL_AHBTHRRATIO_DIV1              0x00000000UL                             /**< Mode DIV1 for USB_DTHRCTL */
#define _USB_DTHRCTL_AHBTHRRATIO_DIV2              0x00000001UL                             /**< Mode DIV2 for USB_DTHRCTL */
#define _USB_DTHRCTL_AHBTHRRATIO_DIV4              0x00000002UL                             /**< Mode DIV4 for USB_DTHRCTL */
#define _USB_DTHRCTL_AHBTHRRATIO_DIV8              0x00000003UL                             /**< Mode DIV8 for USB_DTHRCTL */
#define USB_DTHRCTL_AHBTHRRATIO_DEFAULT            (_USB_DTHRCTL_AHBTHRRATIO_DEFAULT << 11) /**< Shifted mode DEFAULT for USB_DTHRCTL */
#define USB_DTHRCTL_AHBTHRRATIO_DIV1               (_USB_DTHRCTL_AHBTHRRATIO_DIV1 << 11)    /**< Shifted mode DIV1 for USB_DTHRCTL */
#define USB_DTHRCTL_AHBTHRRATIO_DIV2               (_USB_DTHRCTL_AHBTHRRATIO_DIV2 << 11)    /**< Shifted mode DIV2 for USB_DTHRCTL */
#define USB_DTHRCTL_AHBTHRRATIO_DIV4               (_USB_DTHRCTL_AHBTHRRATIO_DIV4 << 11)    /**< Shifted mode DIV4 for USB_DTHRCTL */
#define USB_DTHRCTL_AHBTHRRATIO_DIV8               (_USB_DTHRCTL_AHBTHRRATIO_DIV8 << 11)    /**< Shifted mode DIV8 for USB_DTHRCTL */
...
#define USB_DIEP0INT_BBLEERR                       (0x1UL << 12)                            /**< Babble Interrupt */
...
#define USB_DIEP_INT_BBLEERR                       (0x1UL << 12)                            /**< Babble Interrupt */
