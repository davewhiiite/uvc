...
void spi_format(spi_t *obj, int bits, int mode, int slave)
{
    ...
    /* NOTE: M451's/M480's/M2351's/M251's SPI_Open() will enable SPI transfer (SPI_CTL_SPIEN_Msk).
    ...
    if (obj->spi.dma_usage == DMA_USAGE_NEVER) {
        ...
        PDMA_SetTransferAddr(pdma_base,
                             ...
                             (uint32_t) tx, // NOTE:
                                            ...
                                            // M451/M480/M2351/M251: Start of source address
        ...
        PDMA_SetTransferAddr(pdma_base,
                             ...
                             (uint32_t) rx, // NOTE:
                                            ...
                                            // M451/M480/M2351/M251: Start of destination address
