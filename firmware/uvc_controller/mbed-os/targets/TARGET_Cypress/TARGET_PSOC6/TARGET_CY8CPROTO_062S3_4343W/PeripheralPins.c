...
const PinMap PinMap_PWM_OUT[] = {
    ...
    {P2_0, PWM_16b_3, CYHAL_PIN_OUT_FUNCTION(P2_0_TCPWM1_LINE3)},
    {P2_2, PWM_16b_4, CYHAL_PIN_OUT_FUNCTION(P2_2_TCPWM1_LINE4)},
    {P2_4, PWM_16b_5, CYHAL_PIN_OUT_FUNCTION(P2_4_TCPWM1_LINE5)},
    {P2_6, PWM_16b_6, CYHAL_PIN_OUT_FUNCTION(P2_6_TCPWM1_LINE6)},
    {P3_0, PWM_16b_7, CYHAL_PIN_OUT_FUNCTION(P3_0_TCPWM1_LINE7)},
    {P5_0, PWM_16b_0, CYHAL_PIN_OUT_FUNCTION(P5_0_TCPWM1_LINE0)},
    {P5_6, PWM_16b_1, CYHAL_PIN_OUT_FUNCTION(P5_6_TCPWM1_LINE1)},
    {P6_2, PWM_16b_3, CYHAL_PIN_OUT_FUNCTION(P6_2_TCPWM1_LINE3)},
    {P6_4, PWM_16b_4, CYHAL_PIN_OUT_FUNCTION(P6_4_TCPWM1_LINE4)},
    {P6_6, PWM_16b_5, CYHAL_PIN_OUT_FUNCTION(P6_6_TCPWM1_LINE5)},
    {P7_0, PWM_16b_6, CYHAL_PIN_OUT_FUNCTION(P7_0_TCPWM1_LINE6)},
    {P7_2, PWM_16b_7, CYHAL_PIN_OUT_FUNCTION(P7_2_TCPWM1_LINE7)},
    {P8_0, PWM_16b_2, CYHAL_PIN_OUT_FUNCTION(P8_0_TCPWM1_LINE2)},
    {P9_0, PWM_16b_4, CYHAL_PIN_OUT_FUNCTION(P9_0_TCPWM1_LINE4)},
    {P9_2, PWM_16b_5, CYHAL_PIN_OUT_FUNCTION(P9_2_TCPWM1_LINE5)},
    {P10_0, PWM_16b_6, CYHAL_PIN_OUT_FUNCTION(P10_0_TCPWM1_LINE6)},
    {P10_2, PWM_16b_7, CYHAL_PIN_OUT_FUNCTION(P10_2_TCPWM1_LINE7)},
    {P10_4, PWM_16b_0, CYHAL_PIN_OUT_FUNCTION(P10_4_TCPWM1_LINE0)},
    {P11_0, PWM_16b_2, CYHAL_PIN_OUT_FUNCTION(P11_0_TCPWM1_LINE2)},
    {P11_2, PWM_16b_3, CYHAL_PIN_OUT_FUNCTION(P11_2_TCPWM1_LINE3)},
    {P11_4, PWM_16b_4, CYHAL_PIN_OUT_FUNCTION(P11_4_TCPWM1_LINE4)},
    {P11_6, PWM_16b_5, CYHAL_PIN_OUT_FUNCTION(P11_6_TCPWM1_LINE5)},
    ...
    {P2_1, PWM_16b_3, CYHAL_PIN_OUT_FUNCTION(P2_1_TCPWM1_LINE_COMPL3)},
    {P2_3, PWM_16b_4, CYHAL_PIN_OUT_FUNCTION(P2_3_TCPWM1_LINE_COMPL4)},
    {P2_5, PWM_16b_5, CYHAL_PIN_OUT_FUNCTION(P2_5_TCPWM1_LINE_COMPL5)},
    {P2_7, PWM_16b_6, CYHAL_PIN_OUT_FUNCTION(P2_7_TCPWM1_LINE_COMPL6)},
    {P3_1, PWM_16b_7, CYHAL_PIN_OUT_FUNCTION(P3_1_TCPWM1_LINE_COMPL7)},
    {P5_1, PWM_16b_0, CYHAL_PIN_OUT_FUNCTION(P5_1_TCPWM1_LINE_COMPL0)},
    {P5_7, PWM_16b_1, CYHAL_PIN_OUT_FUNCTION(P5_7_TCPWM1_LINE_COMPL1)},
    {P6_3, PWM_16b_3, CYHAL_PIN_OUT_FUNCTION(P6_3_TCPWM1_LINE_COMPL3)},
    {P6_5, PWM_16b_4, CYHAL_PIN_OUT_FUNCTION(P6_5_TCPWM1_LINE_COMPL4)},
    {P6_7, PWM_16b_5, CYHAL_PIN_OUT_FUNCTION(P6_7_TCPWM1_LINE_COMPL5)},
    {P7_1, PWM_16b_6, CYHAL_PIN_OUT_FUNCTION(P7_1_TCPWM1_LINE_COMPL6)},
    {P7_3, PWM_16b_7, CYHAL_PIN_OUT_FUNCTION(P7_3_TCPWM1_LINE_COMPL7)},
    {P7_7, PWM_16b_1, CYHAL_PIN_OUT_FUNCTION(P7_7_TCPWM1_LINE_COMPL1)},
    {P8_1, PWM_16b_2, CYHAL_PIN_OUT_FUNCTION(P8_1_TCPWM1_LINE_COMPL2)},
    {P9_1, PWM_16b_4, CYHAL_PIN_OUT_FUNCTION(P9_1_TCPWM1_LINE_COMPL4)},
    {P9_3, PWM_16b_5, CYHAL_PIN_OUT_FUNCTION(P9_3_TCPWM1_LINE_COMPL5)},
    {P10_1, PWM_16b_6, CYHAL_PIN_OUT_FUNCTION(P10_1_TCPWM1_LINE_COMPL6)},
    {P10_3, PWM_16b_7, CYHAL_PIN_OUT_FUNCTION(P10_3_TCPWM1_LINE_COMPL7)},
    {P10_5, PWM_16b_0, CYHAL_PIN_OUT_FUNCTION(P10_5_TCPWM1_LINE_COMPL0)},
    {P11_1, PWM_16b_2, CYHAL_PIN_OUT_FUNCTION(P11_1_TCPWM1_LINE_COMPL2)},
    {P11_3, PWM_16b_3, CYHAL_PIN_OUT_FUNCTION(P11_3_TCPWM1_LINE_COMPL3)},
    {P11_5, PWM_16b_4, CYHAL_PIN_OUT_FUNCTION(P11_5_TCPWM1_LINE_COMPL4)},
    {P11_7, PWM_16b_5, CYHAL_PIN_OUT_FUNCTION(P11_7_TCPWM1_LINE_COMPL5)},
    ...
    {P2_0, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P2_0_TCPWM0_LINE3)},
    {P2_2, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P2_2_TCPWM0_LINE0)},
    {P2_4, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P2_4_TCPWM0_LINE1)},
    {P2_6, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P2_6_TCPWM0_LINE2)},
    {P3_0, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P3_0_TCPWM0_LINE3)},
    {P5_0, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P5_0_TCPWM0_LINE0)},
    {P5_6, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P5_6_TCPWM0_LINE1)},
    {P6_2, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P6_2_TCPWM0_LINE3)},
    {P6_4, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P6_4_TCPWM0_LINE0)},
    {P6_6, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P6_6_TCPWM0_LINE1)},
    {P7_0, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P7_0_TCPWM0_LINE2)},
    {P7_2, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P7_2_TCPWM0_LINE3)},
    {P8_0, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P8_0_TCPWM0_LINE2)},
    {P9_0, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P9_0_TCPWM0_LINE0)},
    {P9_2, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P9_2_TCPWM0_LINE1)},
    {P10_0, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P10_0_TCPWM0_LINE2)},
    {P10_2, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P10_2_TCPWM0_LINE3)},
    {P10_4, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P10_4_TCPWM0_LINE0)},
    {P11_0, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P11_0_TCPWM0_LINE2)},
    {P11_2, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P11_2_TCPWM0_LINE3)},
    {P11_4, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P11_4_TCPWM0_LINE0)},
    {P11_6, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P11_6_TCPWM0_LINE1)},
    {P12_6, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P12_6_TCPWM0_LINE3)},
    ...
    {P2_1, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P2_1_TCPWM0_LINE_COMPL3)},
    {P2_3, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P2_3_TCPWM0_LINE_COMPL0)},
    {P2_5, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P2_5_TCPWM0_LINE_COMPL1)},
    {P2_7, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P2_7_TCPWM0_LINE_COMPL2)},
    {P3_1, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P3_1_TCPWM0_LINE_COMPL3)},
    {P5_1, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P5_1_TCPWM0_LINE_COMPL0)},
    {P5_7, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P5_7_TCPWM0_LINE_COMPL1)},
    {P6_3, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P6_3_TCPWM0_LINE_COMPL3)},
    {P6_5, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P6_5_TCPWM0_LINE_COMPL0)},
    {P6_7, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P6_7_TCPWM0_LINE_COMPL1)},
    {P7_1, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P7_1_TCPWM0_LINE_COMPL2)},
    {P7_3, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P7_3_TCPWM0_LINE_COMPL3)},
    {P7_7, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P7_7_TCPWM0_LINE_COMPL1)},
    {P8_1, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P8_1_TCPWM0_LINE_COMPL2)},
    {P9_1, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P9_1_TCPWM0_LINE_COMPL0)},
    {P9_3, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P9_3_TCPWM0_LINE_COMPL1)},
    {P10_1, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P10_1_TCPWM0_LINE_COMPL2)},
    {P10_3, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P10_3_TCPWM0_LINE_COMPL3)},
    {P10_5, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P10_5_TCPWM0_LINE_COMPL0)},
    {P11_1, PWM_32b_2, CYHAL_PIN_OUT_FUNCTION(P11_1_TCPWM0_LINE_COMPL2)},
    {P11_3, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P11_3_TCPWM0_LINE_COMPL3)},
    {P11_5, PWM_32b_0, CYHAL_PIN_OUT_FUNCTION(P11_5_TCPWM0_LINE_COMPL0)},
    {P11_7, PWM_32b_1, CYHAL_PIN_OUT_FUNCTION(P11_7_TCPWM0_LINE_COMPL1)},
    {P12_7, PWM_32b_3, CYHAL_PIN_OUT_FUNCTION(P12_7_TCPWM0_LINE_COMPL3)},
    {NC,    NC,     0}
};
#endif // DEVICE_PWMOUT
