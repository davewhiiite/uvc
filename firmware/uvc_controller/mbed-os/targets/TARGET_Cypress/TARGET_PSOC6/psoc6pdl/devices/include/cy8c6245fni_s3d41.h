...
#ifndef _CY8C6245FNI_S3D41_H_
#define _CY8C6245FNI_S3D41_H_

/**
* \addtogroup group_device CY8C6245FNI-S3D41
* \{
*/
...
typedef enum {
  ...
  /* CY8C6245FNI-S3D41 User Interrupt Numbers */
  ...
  /* CY8C6245FNI-S3D41 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C6245FNI-S3D41 Peripheral Interrupt Numbers */
...
#define CY_SILICON_ID                   0xE7071105UL
