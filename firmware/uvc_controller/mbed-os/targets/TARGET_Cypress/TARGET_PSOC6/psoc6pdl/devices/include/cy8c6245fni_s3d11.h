...
#ifndef _CY8C6245FNI_S3D11_H_
#define _CY8C6245FNI_S3D11_H_

/**
* \addtogroup group_device CY8C6245FNI-S3D11
* \{
*/
...
typedef enum {
  ...
  /* CY8C6245FNI-S3D11 User Interrupt Numbers */
  ...
  /* CY8C6245FNI-S3D11 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C6245FNI-S3D11 Peripheral Interrupt Numbers */
...
#define CY_SILICON_ID                   0xE70A1105UL
