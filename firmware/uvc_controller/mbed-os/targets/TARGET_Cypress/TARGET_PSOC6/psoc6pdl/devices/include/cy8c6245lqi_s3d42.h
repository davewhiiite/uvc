...
#ifndef _CY8C6245LQI_S3D42_H_
#define _CY8C6245LQI_S3D42_H_

/**
* \addtogroup group_device CY8C6245LQI-S3D42
* \{
*/
...
typedef enum {
  ...
  /* CY8C6245LQI-S3D42 User Interrupt Numbers */
  ...
  /* CY8C6245LQI-S3D42 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C6245LQI-S3D42 Peripheral Interrupt Numbers */
...
#define CY_SILICON_ID                   0xE7061105UL
