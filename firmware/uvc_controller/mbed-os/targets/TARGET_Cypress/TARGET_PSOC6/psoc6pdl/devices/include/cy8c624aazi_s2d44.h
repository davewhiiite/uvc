...
#ifndef _CY8C624AAZI_S2D44_H_
#define _CY8C624AAZI_S2D44_H_

/**
* \addtogroup group_device CY8C624AAZI-S2D44
* \{
*/
...
typedef enum {
  ...
  /* CY8C624AAZI-S2D44 User Interrupt Numbers */
  ...
  /* CY8C624AAZI-S2D44 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C624AAZI-S2D44 Peripheral Interrupt Numbers */
...
/* CY8C624AAZI-S2D44 interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_1_IRQn       =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
