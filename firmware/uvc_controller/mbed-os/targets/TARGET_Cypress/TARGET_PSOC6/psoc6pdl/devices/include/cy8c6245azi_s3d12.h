...
#ifndef _CY8C6245AZI_S3D12_H_
#define _CY8C6245AZI_S3D12_H_

/**
* \addtogroup group_device CY8C6245AZI-S3D12
* \{
*/
...
typedef enum {
  ...
  /* CY8C6245AZI-S3D12 User Interrupt Numbers */
  ...
  /* CY8C6245AZI-S3D12 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C6245AZI-S3D12 Peripheral Interrupt Numbers */
...
#define CY_SILICON_ID                   0xE7081105UL
