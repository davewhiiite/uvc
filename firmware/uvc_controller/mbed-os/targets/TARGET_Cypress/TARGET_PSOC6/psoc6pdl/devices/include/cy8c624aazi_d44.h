...
#ifndef _CY8C624AAZI_D44_H_
#define _CY8C624AAZI_D44_H_

/**
* \addtogroup group_device CY8C624AAZI-D44
* \{
*/
...
typedef enum {
  ...
  /* CY8C624AAZI-D44 User Interrupt Numbers */
  ...
  /* CY8C624AAZI-D44 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C624AAZI-D44 Peripheral Interrupt Numbers */
...
#define CY_SILICON_ID                   0xE40B1102UL
