...
#ifndef _CY8C6245LQI_S3D02_H_
#define _CY8C6245LQI_S3D02_H_

/**
* \addtogroup group_device CY8C6245LQI-S3D02
* \{
*/
...
typedef enum {
  ...
  /* CY8C6245LQI-S3D02 User Interrupt Numbers */
  ...
  /* CY8C6245LQI-S3D02 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C6245LQI-S3D02 Peripheral Interrupt Numbers */
...
#define CY_SILICON_ID                   0xE70C1105UL
