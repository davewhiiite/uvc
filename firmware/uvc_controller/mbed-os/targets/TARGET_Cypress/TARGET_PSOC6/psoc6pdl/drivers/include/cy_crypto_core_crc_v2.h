...
#if !defined(CY_CRYPTO_CORE_CRC_V2_H)
#define CY_CRYPTO_CORE_CRC_V2_H
...
cy_en_crypto_status_t Cy_Crypto_Core_V2_Crc_CalcPartial(CRYPTO_Type *base, void const *data, uint32_t  dataSize);
...
#endif /* #if !defined(CY_CRYPTO_CORE_CRC_V2_H) */
