...
const cy_stc_smif_mem_cmd_t S25FS512S_SlaveSlot_0_readCmd =
{
...
const cy_stc_smif_mem_cmd_t S25FS512S_SlaveSlot_0_writeEnCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x06U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25FS512S_SlaveSlot_0_writeDisCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x04U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25FS512S_SlaveSlot_0_chipEraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x60U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25FS512S_SlaveSlot_0_programCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x12U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25FS512S_SlaveSlot_0_readStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x35U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25FS512S_SlaveSlot_0_readStsRegWipCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x05U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_device_cfg_t deviceCfg_S25FS512S_SlaveSlot_0 =
{
    ...
    .readCmd = (cy_stc_smif_mem_cmd_t*)&S25FS512S_SlaveSlot_0_readCmd,
    /* Specifies the Write Enable command. */
    .writeEnCmd = (cy_stc_smif_mem_cmd_t*)&S25FS512S_SlaveSlot_0_writeEnCmd,
    /* Specifies the Write Disable command. */
    .writeDisCmd = (cy_stc_smif_mem_cmd_t*)&S25FS512S_SlaveSlot_0_writeDisCmd,
    ...
    .programCmd = (cy_stc_smif_mem_cmd_t*)&S25FS512S_SlaveSlot_0_programCmd,
    ...
    .readStsRegQeCmd = (cy_stc_smif_mem_cmd_t*)&S25FS512S_SlaveSlot_0_readStsRegQeCmd,
    /* Specifies the command to read the WIP-containing status register. */
    .readStsRegWipCmd = (cy_stc_smif_mem_cmd_t*)&S25FS512S_SlaveSlot_0_readStsRegWipCmd,
...
const cy_stc_smif_mem_config_t S25FS512S_SlaveSlot_0 =
{
    ...
    .deviceCfg = (cy_stc_smif_mem_device_cfg_t*)&deviceCfg_S25FS512S_SlaveSlot_0
};

const cy_stc_smif_mem_config_t* const smifMemConfigs[] = {
   &S25FS512S_SlaveSlot_0
};
