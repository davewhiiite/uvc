...
//Create instance
MCP3221_navg::MCP3221_navg(PinName sda, PinName scl, float supplyVoltage, uint8_t N) : i2c(sda, scl), _supplyVoltage(supplyVoltage), _enn(N)
{
}

//destroy instance
MCP3221_navg::~MCP3221_navg()
{
}

float MCP3221_navg::read()
{
